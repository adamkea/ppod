export const queryKeys = {
  ...
  gameComments: (gameId: string) => ['game', gameId, 'comments'] as const,
  podCommentCounts: (podId: string) => ['pod', podId, 'comment-counts'] as const,
  playerCommanders: (playerId: string) => ['playerCommanders', playerId] as const,
  seasons: (podId: string) => ['pod', podId, 'seasons'] as const,
